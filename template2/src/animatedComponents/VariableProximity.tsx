...
function useMousePositionRef(
  ...
  useEffect(() => {
    const updatePosition = (x: number, y: number) => {
      if (hasPointerMovedRef) hasPointerMovedRef.current = true;
  ...
  }, [containerRef, hasPointerMovedRef]);
...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>((props, ref) => {
  ...
  const mousePositionRef = useMousePositionRef(containerRef, hasPointerMovedRef);
  ...
  useAnimationFrame(() => {
    ...
    // Until the user has moved the pointer, keep all letters in rest state (no proximity animation)
